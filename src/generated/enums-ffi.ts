...
interface NativeModuleInterface {
  ...
  ubrn_ffi_enums_uniffi_contract_version(): number;
}

// Casting globalThis to any allows us to look for `NativeEnums`
// if it was added via JSI.
//
// We use a getter here rather than simply `globalThis.NativeEnums` so that
// if/when the startup sequence isn't just so, an empty value isn't inadvertantly cached.
const getter: () => NativeModuleInterface = () =>
  (globalThis as any).NativeEnums;
