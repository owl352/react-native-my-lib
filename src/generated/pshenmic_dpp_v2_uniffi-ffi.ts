...
interface NativeModuleInterface {
  ...
  ubrn_uniffi_pshenmic_dpp_fn_clone_identifier(
    ptr: bigint,
    uniffi_out_err: UniffiRustCallStatus
  ): bigint;
  ubrn_uniffi_pshenmic_dpp_fn_free_identifier(
    ptr: bigint,
    uniffi_out_err: UniffiRustCallStatus
  ): void;
  ubrn_uniffi_pshenmic_dpp_fn_constructor_identifier_new(
    id: Uint8Array,
    uniffi_out_err: UniffiRustCallStatus
  ): bigint;
  ubrn_uniffi_pshenmic_dpp_fn_method_identifier_to_hex(
    ptr: bigint,
    uniffi_out_err: UniffiRustCallStatus
  ): Uint8Array;
  ubrn_uniffi_pshenmic_dpp_checksum_method_identifier_to_hex(): number;
  ubrn_uniffi_pshenmic_dpp_checksum_constructor_identifier_new(): number;
