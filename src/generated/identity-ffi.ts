...
interface NativeModuleInterface {
  ...
  ubrn_uniffi_identity_fn_clone_identityffi(
    ptr: bigint,
    uniffi_out_err: UniffiRustCallStatus
  ): bigint;
  ...
  ubrn_uniffi_identity_fn_constructor_identityffi_new(
    id: bigint,
    platformVersion: Uint8Array,
    uniffi_out_err: UniffiRustCallStatus
  ): bigint;
  ubrn_uniffi_identity_fn_method_identityffi_get_balance(
    ptr: bigint,
    uniffi_out_err: UniffiRustCallStatus
  ): bigint;
  ubrn_uniffi_identity_fn_method_identityffi_set_balance(
    ptr: bigint,
    balance: bigint,
    uniffi_out_err: UniffiRustCallStatus
  ): void;
  ubrn_uniffi_identity_checksum_method_identityffi_get_balance(): number;
  ubrn_uniffi_identity_checksum_method_identityffi_set_balance(): number;
  ubrn_uniffi_identity_checksum_constructor_identityffi_new(): number;
  ubrn_ffi_identity_uniffi_contract_version(): number;
...
// Casting globalThis to any allows us to look for `NativeIdentity`
// if it was added via JSI.
//
// We use a getter here rather than simply `globalThis.NativeIdentity` so that
// if/when the startup sequence isn't just so, an empty value isn't inadvertantly cached.
const getter: () => NativeModuleInterface = () =>
  (globalThis as any).NativeIdentity;
