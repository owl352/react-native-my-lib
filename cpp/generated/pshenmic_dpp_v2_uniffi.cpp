...
// it!
#include "pshenmic_dpp_v2_uniffi.hpp"
...
void *uniffi_pshenmic_dpp_fn_clone_identifier(void *ptr,
                                              RustCallStatus *uniffi_out_err);
void uniffi_pshenmic_dpp_fn_free_identifier(void *ptr,
                                            RustCallStatus *uniffi_out_err);
void *uniffi_pshenmic_dpp_fn_constructor_identifier_new(
    RustBuffer id, RustCallStatus *uniffi_out_err);
RustBuffer
uniffi_pshenmic_dpp_fn_method_identifier_to_hex(void *ptr,
                                                RustCallStatus *uniffi_out_err);
RustBuffer ffi_pshenmic_dpp_rustbuffer_alloc(uint64_t size,
                                             RustCallStatus *uniffi_out_err);
RustBuffer
ffi_pshenmic_dpp_rustbuffer_from_bytes(ForeignBytes bytes,
                                       RustCallStatus *uniffi_out_err);
void ffi_pshenmic_dpp_rustbuffer_free(RustBuffer buf,
                                      RustCallStatus *uniffi_out_err);
RustBuffer ffi_pshenmic_dpp_rustbuffer_reserve(RustBuffer buf,
                                               uint64_t additional,
                                               RustCallStatus *uniffi_out_err);
void ffi_pshenmic_dpp_rust_future_poll_u8(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_pshenmic_dpp_rust_future_cancel_u8(
    /*handle*/ uint64_t handle);
void ffi_pshenmic_dpp_rust_future_free_u8(
    /*handle*/ uint64_t handle);
uint8_t ffi_pshenmic_dpp_rust_future_complete_u8(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_pshenmic_dpp_rust_future_poll_i8(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_pshenmic_dpp_rust_future_cancel_i8(
    /*handle*/ uint64_t handle);
void ffi_pshenmic_dpp_rust_future_free_i8(
    /*handle*/ uint64_t handle);
int8_t ffi_pshenmic_dpp_rust_future_complete_i8(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_pshenmic_dpp_rust_future_poll_u16(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_pshenmic_dpp_rust_future_cancel_u16(
    /*handle*/ uint64_t handle);
void ffi_pshenmic_dpp_rust_future_free_u16(
    /*handle*/ uint64_t handle);
uint16_t ffi_pshenmic_dpp_rust_future_complete_u16(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_pshenmic_dpp_rust_future_poll_i16(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_pshenmic_dpp_rust_future_cancel_i16(
    /*handle*/ uint64_t handle);
void ffi_pshenmic_dpp_rust_future_free_i16(
    /*handle*/ uint64_t handle);
int16_t ffi_pshenmic_dpp_rust_future_complete_i16(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_pshenmic_dpp_rust_future_poll_u32(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_pshenmic_dpp_rust_future_cancel_u32(
    /*handle*/ uint64_t handle);
void ffi_pshenmic_dpp_rust_future_free_u32(
    /*handle*/ uint64_t handle);
uint32_t ffi_pshenmic_dpp_rust_future_complete_u32(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_pshenmic_dpp_rust_future_poll_i32(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_pshenmic_dpp_rust_future_cancel_i32(
    /*handle*/ uint64_t handle);
void ffi_pshenmic_dpp_rust_future_free_i32(
    /*handle*/ uint64_t handle);
int32_t ffi_pshenmic_dpp_rust_future_complete_i32(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_pshenmic_dpp_rust_future_poll_u64(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_pshenmic_dpp_rust_future_cancel_u64(
    /*handle*/ uint64_t handle);
void ffi_pshenmic_dpp_rust_future_free_u64(
    /*handle*/ uint64_t handle);
uint64_t ffi_pshenmic_dpp_rust_future_complete_u64(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_pshenmic_dpp_rust_future_poll_i64(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_pshenmic_dpp_rust_future_cancel_i64(
    /*handle*/ uint64_t handle);
void ffi_pshenmic_dpp_rust_future_free_i64(
    /*handle*/ uint64_t handle);
int64_t ffi_pshenmic_dpp_rust_future_complete_i64(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_pshenmic_dpp_rust_future_poll_f32(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_pshenmic_dpp_rust_future_cancel_f32(
    /*handle*/ uint64_t handle);
void ffi_pshenmic_dpp_rust_future_free_f32(
    /*handle*/ uint64_t handle);
float ffi_pshenmic_dpp_rust_future_complete_f32(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_pshenmic_dpp_rust_future_poll_f64(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_pshenmic_dpp_rust_future_cancel_f64(
    /*handle*/ uint64_t handle);
void ffi_pshenmic_dpp_rust_future_free_f64(
    /*handle*/ uint64_t handle);
double ffi_pshenmic_dpp_rust_future_complete_f64(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_pshenmic_dpp_rust_future_poll_pointer(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_pshenmic_dpp_rust_future_cancel_pointer(
    /*handle*/ uint64_t handle);
void ffi_pshenmic_dpp_rust_future_free_pointer(
    /*handle*/ uint64_t handle);
void *ffi_pshenmic_dpp_rust_future_complete_pointer(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_pshenmic_dpp_rust_future_poll_rust_buffer(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_pshenmic_dpp_rust_future_cancel_rust_buffer(
    /*handle*/ uint64_t handle);
void ffi_pshenmic_dpp_rust_future_free_rust_buffer(
    /*handle*/ uint64_t handle);
RustBuffer ffi_pshenmic_dpp_rust_future_complete_rust_buffer(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_pshenmic_dpp_rust_future_poll_void(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_pshenmic_dpp_rust_future_cancel_void(
    /*handle*/ uint64_t handle);
void ffi_pshenmic_dpp_rust_future_free_void(
    /*handle*/ uint64_t handle);
void ffi_pshenmic_dpp_rust_future_complete_void(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
uint16_t uniffi_pshenmic_dpp_checksum_method_identifier_to_hex();
uint16_t uniffi_pshenmic_dpp_checksum_constructor_identifier_new();
uint32_t ffi_pshenmic_dpp_uniffi_contract_version();
}

namespace uniffi::pshenmic_dpp_v2_uniffi {
...
template <typename T> struct Bridging<ReferenceHolder<T>> {
  ...
  static T fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
    ...
    if (obj.hasProperty(rt, "pointee")) {
      ...
      return uniffi::pshenmic_dpp_v2_uniffi::Bridging<T>::fromJs(
...
template <> struct Bridging<RustBuffer> {
  static RustBuffer rustbuffer_alloc(int32_t size) {
    ...
    return ffi_pshenmic_dpp_rustbuffer_alloc(size, &status);
  }

  static void rustbuffer_free(RustBuffer buf) {
    RustCallStatus status = {UNIFFI_CALL_STATUS_OK};
    ffi_pshenmic_dpp_rustbuffer_free(buf, &status);
  }

  static RustBuffer rustbuffer_from_bytes(ForeignBytes bytes) {
    RustCallStatus status = {UNIFFI_CALL_STATUS_OK};
    return ffi_pshenmic_dpp_rustbuffer_from_bytes(bytes, &status);
  }
...
namespace uniffi::pshenmic_dpp_v2_uniffi::registry {
...
// Callback function:
// uniffi::pshenmic_dpp_v2_uniffi::cb::rustfuturecontinuationcallback::UniffiRustFutureContinuationCallback
//
...
namespace uniffi::pshenmic_dpp_v2_uniffi::cb::rustfuturecontinuationcallback {
using namespace facebook;
...
makeCallbackFunction( // uniffi::pshenmic_dpp_v2_uniffi::cb::rustfuturecontinuationcallback
    jsi::Runtime &rt,
    std::shared_ptr<uniffi_runtime::UniffiCallInvoker> callInvoker,
    const jsi::Value &value) {
  if (rsLambda != nullptr) {
...
// This method is called from the destructor of NativePshenmicDppV2Uniffi, which
...
static void cleanup() {
  ...
  // uniffi::pshenmic_dpp_v2_uniffi::cb::rustfuturecontinuationcallback
...
// Callback function:
// uniffi::pshenmic_dpp_v2_uniffi::st::foreignfuture::foreignfuture::free::UniffiCallbackInterfaceFree
//
// We have the following constraints:
// - we need to pass a function pointer to Rust.
// - we need a jsi::Runtime and jsi::Function to call into JS.
...
// We then give the `callback` function pointer to Rust which will call the
// lambda sometime in the future.
namespace uniffi::pshenmic_dpp_v2_uniffi::st::foreignfuture::foreignfuture::
    free {
using namespace facebook;
...
makeCallbackFunction( // uniffi::pshenmic_dpp_v2_uniffi::st::foreignfuture::foreignfuture::free
    jsi::Runtime &rt,
    std::shared_ptr<uniffi_runtime::UniffiCallInvoker> callInvoker,
    const jsi::Value &value) {
  if (rsLambda != nullptr) {
...
static void cleanup() {
  ...
  // uniffi::pshenmic_dpp_v2_uniffi::st::foreignfuture::foreignfuture::free
namespace uniffi::pshenmic_dpp_v2_uniffi {
using namespace facebook;
using CallInvoker = uniffi_runtime::UniffiCallInvoker;
...
template <> struct Bridging<UniffiForeignFuture> {
  static UniffiForeignFuture fromJs(jsi::Runtime &rt,
    ...
    rsObject.free = uniffi::pshenmic_dpp_v2_uniffi::st::foreignfuture::
...
template <> struct Bridging<UniffiForeignFutureStructU8> {
  ...
  fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
    ...
    rsObject.call_status =
        uniffi::pshenmic_dpp_v2_uniffi::Bridging<RustCallStatus>::fromJs(
...
template <> struct Bridging<UniffiForeignFutureCompleteU8> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::pshenmic_dpp_v2_uniffi::Bridging<
...
template <> struct Bridging<UniffiForeignFutureStructRustBuffer> {
  ...
  fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
    ...
    rsObject.return_value =
        uniffi::pshenmic_dpp_v2_uniffi::Bridging<RustBuffer>::fromJs(
            rt, callInvoker, jsObject.getProperty(rt, "returnValue"));
    rsObject.call_status =
        uniffi::pshenmic_dpp_v2_uniffi::Bridging<RustCallStatus>::fromJs(
            rt, callInvoker, jsObject.getProperty(rt, "callStatus"));
...
template <> struct Bridging<UniffiRustFutureContinuationCallback> {
  ...
  fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
         const jsi::Value &value) {
    try {
      return uniffi::pshenmic_dpp_v2_uniffi::cb::
...
NativePshenmicDppV2Uniffi::NativePshenmicDppV2Uniffi(
    jsi::Runtime &rt,
  ...
  props["ubrn_uniffi_pshenmic_dpp_fn_clone_identifier"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "ubrn_uniffi_pshenmic_dpp_fn_clone_identifier"),
          1,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_uniffi_pshenmic_dpp_fn_clone_identifier(
                rt, thisVal, args, count);
          });
  props["ubrn_uniffi_pshenmic_dpp_fn_free_identifier"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "ubrn_uniffi_pshenmic_dpp_fn_free_identifier"),
          1,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_uniffi_pshenmic_dpp_fn_free_identifier(
                rt, thisVal, args, count);
          });
  props["ubrn_uniffi_pshenmic_dpp_fn_constructor_identifier_new"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "ubrn_uniffi_pshenmic_dpp_fn_constructor_identifier_new"),
          1,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_uniffi_pshenmic_dpp_fn_constructor_identifier_new(
                rt, thisVal, args, count);
          });
  props["ubrn_uniffi_pshenmic_dpp_fn_method_identifier_to_hex"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "ubrn_uniffi_pshenmic_dpp_fn_method_identifier_to_hex"),
          1,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_uniffi_pshenmic_dpp_fn_method_identifier_to_hex(
                rt, thisVal, args, count);
          });
  props["ubrn_uniffi_pshenmic_dpp_checksum_method_identifier_to_hex"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "ubrn_uniffi_pshenmic_dpp_checksum_method_identifier_to_hex"),
          0,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_pshenmic_dpp_checksum_method_identifier_to_hex(
                    rt, thisVal, args, count);
          });
  props["ubrn_uniffi_pshenmic_dpp_checksum_constructor_identifier_new"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt,
              "ubrn_uniffi_pshenmic_dpp_checksum_constructor_identifier_new"),
          0,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_pshenmic_dpp_checksum_constructor_identifier_new(
                    rt, thisVal, args, count);
          });
  props["ubrn_ffi_pshenmic_dpp_uniffi_contract_version"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "ubrn_ffi_pshenmic_dpp_uniffi_contract_version"),
          0,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_ffi_pshenmic_dpp_uniffi_contract_version(
                rt, thisVal, args, count);
          });
  props["ubrn_uniffi_internal_fn_method_identifier_ffi__bless_pointer"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt,
              "ubrn_uniffi_internal_fn_method_identifier_ffi__bless_pointer"),
          1,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_internal_fn_method_identifier_ffi__bless_pointer(
                    rt, thisVal, args, count);
          });
}

void NativePshenmicDppV2Uniffi::registerModule(
    jsi::Runtime &rt, std::shared_ptr<react::CallInvoker> callInvoker) {
  auto invoker =
      std::make_shared<uniffi_runtime::UniffiCallInvoker>(callInvoker);
  auto tm = std::make_shared<NativePshenmicDppV2Uniffi>(rt, invoker);
  auto obj = rt.global().createFromHostObject(rt, tm);
  rt.global().setProperty(rt, "NativePshenmicDppV2Uniffi", obj);
}

void NativePshenmicDppV2Uniffi::unregisterModule(jsi::Runtime &rt) {
  uniffi::pshenmic_dpp_v2_uniffi::registry::clearRegistry();
}

jsi::Value NativePshenmicDppV2Uniffi::get(jsi::Runtime &rt,
...
NativePshenmicDppV2Uniffi::getPropertyNames(jsi::Runtime &rt) {
...
void NativePshenmicDppV2Uniffi::set(jsi::Runtime &rt,
                                    const jsi::PropNameID &name,
                                    const jsi::Value &value) {
...
NativePshenmicDppV2Uniffi::~NativePshenmicDppV2Uniffi() {
  ...
  uniffi::pshenmic_dpp_v2_uniffi::cb::rustfuturecontinuationcallback::cleanup();
...
jsi::Value NativePshenmicDppV2Uniffi::
...
jsi::Value NativePshenmicDppV2Uniffi::
  ...
  auto static destructor = [](uint64_t p) {
    ...
    uniffi_pshenmic_dpp_fn_free_identifier(pointer, &status);
  };
  auto ptrObj =
...
jsi::Value
NativePshenmicDppV2Uniffi::cpp_uniffi_pshenmic_dpp_fn_clone_identifier(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
  RustCallStatus status =
      uniffi::pshenmic_dpp_v2_uniffi::Bridging<RustCallStatus>::rustSuccess(rt);
  auto value = uniffi_pshenmic_dpp_fn_clone_identifier(
      uniffi_jsi::Bridging<void *>::fromJs(rt, callInvoker, args[0]), &status);
  uniffi::pshenmic_dpp_v2_uniffi::Bridging<RustCallStatus>::copyIntoJs(
      rt, callInvoker, status, args[count - 1]);

  return uniffi_jsi::Bridging<void *>::toJs(rt, callInvoker, value);
}
jsi::Value
NativePshenmicDppV2Uniffi::cpp_uniffi_pshenmic_dpp_fn_free_identifier(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
  RustCallStatus status =
      uniffi::pshenmic_dpp_v2_uniffi::Bridging<RustCallStatus>::rustSuccess(rt);
  uniffi_pshenmic_dpp_fn_free_identifier(
      uniffi_jsi::Bridging<void *>::fromJs(rt, callInvoker, args[0]), &status);
  uniffi::pshenmic_dpp_v2_uniffi::Bridging<RustCallStatus>::copyIntoJs(
      rt, callInvoker, status, args[count - 1]);
...
jsi::Value NativePshenmicDppV2Uniffi::
    cpp_uniffi_pshenmic_dpp_fn_constructor_identifier_new(
        jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
        size_t count) {
  RustCallStatus status =
      uniffi::pshenmic_dpp_v2_uniffi::Bridging<RustCallStatus>::rustSuccess(rt);
  auto value = uniffi_pshenmic_dpp_fn_constructor_identifier_new(
      uniffi::pshenmic_dpp_v2_uniffi::Bridging<RustBuffer>::fromJs(
...
jsi::Value
NativePshenmicDppV2Uniffi::cpp_uniffi_pshenmic_dpp_fn_method_identifier_to_hex(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
  RustCallStatus status =
      uniffi::pshenmic_dpp_v2_uniffi::Bridging<RustCallStatus>::rustSuccess(rt);
  auto value = uniffi_pshenmic_dpp_fn_method_identifier_to_hex(
      uniffi_jsi::Bridging<void *>::fromJs(rt, callInvoker, args[0]), &status);
  uniffi::pshenmic_dpp_v2_uniffi::Bridging<RustCallStatus>::copyIntoJs(
      rt, callInvoker, status, args[count - 1]);

  return uniffi::pshenmic_dpp_v2_uniffi::Bridging<RustBuffer>::toJs(
...
jsi::Value NativePshenmicDppV2Uniffi::
    cpp_uniffi_pshenmic_dpp_checksum_method_identifier_to_hex(
        jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
        size_t count) {
  auto value = uniffi_pshenmic_dpp_checksum_method_identifier_to_hex();
...
jsi::Value NativePshenmicDppV2Uniffi::
    cpp_uniffi_pshenmic_dpp_checksum_constructor_identifier_new(
        jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
        size_t count) {
  auto value = uniffi_pshenmic_dpp_checksum_constructor_identifier_new();

  return uniffi_jsi::Bridging<uint16_t>::toJs(rt, callInvoker, value);
}
jsi::Value
NativePshenmicDppV2Uniffi::cpp_ffi_pshenmic_dpp_uniffi_contract_version(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
  auto value = ffi_pshenmic_dpp_uniffi_contract_version();
