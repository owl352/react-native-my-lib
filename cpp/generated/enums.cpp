...
RustBuffer ffi_enums_rustbuffer_alloc(uint64_t size,
                                      RustCallStatus *uniffi_out_err);
RustBuffer ffi_enums_rustbuffer_from_bytes(ForeignBytes bytes,
                                           RustCallStatus *uniffi_out_err);
void ffi_enums_rustbuffer_free(RustBuffer buf, RustCallStatus *uniffi_out_err);
RustBuffer ffi_enums_rustbuffer_reserve(RustBuffer buf, uint64_t additional,
                                        RustCallStatus *uniffi_out_err);
void ffi_enums_rust_future_poll_u8(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_enums_rust_future_cancel_u8(
    /*handle*/ uint64_t handle);
void ffi_enums_rust_future_free_u8(
    /*handle*/ uint64_t handle);
uint8_t ffi_enums_rust_future_complete_u8(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_enums_rust_future_poll_i8(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_enums_rust_future_cancel_i8(
    /*handle*/ uint64_t handle);
void ffi_enums_rust_future_free_i8(
    /*handle*/ uint64_t handle);
int8_t ffi_enums_rust_future_complete_i8(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_enums_rust_future_poll_u16(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_enums_rust_future_cancel_u16(
    /*handle*/ uint64_t handle);
void ffi_enums_rust_future_free_u16(
    /*handle*/ uint64_t handle);
uint16_t ffi_enums_rust_future_complete_u16(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_enums_rust_future_poll_i16(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_enums_rust_future_cancel_i16(
    /*handle*/ uint64_t handle);
void ffi_enums_rust_future_free_i16(
    /*handle*/ uint64_t handle);
int16_t ffi_enums_rust_future_complete_i16(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_enums_rust_future_poll_u32(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_enums_rust_future_cancel_u32(
    /*handle*/ uint64_t handle);
void ffi_enums_rust_future_free_u32(
    /*handle*/ uint64_t handle);
uint32_t ffi_enums_rust_future_complete_u32(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_enums_rust_future_poll_i32(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_enums_rust_future_cancel_i32(
    /*handle*/ uint64_t handle);
void ffi_enums_rust_future_free_i32(
    /*handle*/ uint64_t handle);
int32_t ffi_enums_rust_future_complete_i32(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_enums_rust_future_poll_u64(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_enums_rust_future_cancel_u64(
    /*handle*/ uint64_t handle);
void ffi_enums_rust_future_free_u64(
    /*handle*/ uint64_t handle);
uint64_t ffi_enums_rust_future_complete_u64(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_enums_rust_future_poll_i64(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_enums_rust_future_cancel_i64(
    /*handle*/ uint64_t handle);
void ffi_enums_rust_future_free_i64(
    /*handle*/ uint64_t handle);
int64_t ffi_enums_rust_future_complete_i64(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_enums_rust_future_poll_f32(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_enums_rust_future_cancel_f32(
    /*handle*/ uint64_t handle);
void ffi_enums_rust_future_free_f32(
    /*handle*/ uint64_t handle);
float ffi_enums_rust_future_complete_f32(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_enums_rust_future_poll_f64(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_enums_rust_future_cancel_f64(
    /*handle*/ uint64_t handle);
void ffi_enums_rust_future_free_f64(
    /*handle*/ uint64_t handle);
double ffi_enums_rust_future_complete_f64(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_enums_rust_future_poll_pointer(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_enums_rust_future_cancel_pointer(
    /*handle*/ uint64_t handle);
void ffi_enums_rust_future_free_pointer(
    /*handle*/ uint64_t handle);
void *ffi_enums_rust_future_complete_pointer(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_enums_rust_future_poll_rust_buffer(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_enums_rust_future_cancel_rust_buffer(
    /*handle*/ uint64_t handle);
void ffi_enums_rust_future_free_rust_buffer(
    /*handle*/ uint64_t handle);
RustBuffer ffi_enums_rust_future_complete_rust_buffer(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_enums_rust_future_poll_void(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_enums_rust_future_cancel_void(
    /*handle*/ uint64_t handle);
void ffi_enums_rust_future_free_void(
    /*handle*/ uint64_t handle);
void ffi_enums_rust_future_complete_void(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
uint32_t ffi_enums_uniffi_contract_version();
}

namespace uniffi::enums {
...
template <typename T> struct Bridging<ReferenceHolder<T>> {
  ...
  static T fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
    ...
    if (obj.hasProperty(rt, "pointee")) {
      ...
      return uniffi::enums::Bridging<T>::fromJs(rt, callInvoker, pointee);
    }
...
template <> struct Bridging<RustBuffer> {
  static RustBuffer rustbuffer_alloc(int32_t size) {
    ...
    return ffi_enums_rustbuffer_alloc(size, &status);
  }

  static void rustbuffer_free(RustBuffer buf) {
    RustCallStatus status = {UNIFFI_CALL_STATUS_OK};
    ffi_enums_rustbuffer_free(buf, &status);
  }

  static RustBuffer rustbuffer_from_bytes(ForeignBytes bytes) {
    RustCallStatus status = {UNIFFI_CALL_STATUS_OK};
    return ffi_enums_rustbuffer_from_bytes(bytes, &status);
  }
...
namespace uniffi::enums::registry {
...
// Callback function:
// uniffi::enums::cb::rustfuturecontinuationcallback::UniffiRustFutureContinuationCallback
//
...
namespace uniffi::enums::cb::rustfuturecontinuationcallback {
using namespace facebook;
...
makeCallbackFunction( // uniffi::enums::cb::rustfuturecontinuationcallback
    jsi::Runtime &rt,
    std::shared_ptr<uniffi_runtime::UniffiCallInvoker> callInvoker,
    const jsi::Value &value) {
  if (rsLambda != nullptr) {
...
// This method is called from the destructor of NativeEnums, which only happens
...
// Callback function:
// uniffi::enums::st::foreignfuture::foreignfuture::free::UniffiCallbackInterfaceFree
//
// We have the following constraints:
// - we need to pass a function pointer to Rust.
// - we need a jsi::Runtime and jsi::Function to call into JS.
...
// We then give the `callback` function pointer to Rust which will call the
// lambda sometime in the future.
namespace uniffi::enums::st::foreignfuture::foreignfuture::free {
using namespace facebook;
...
makeCallbackFunction( // uniffi::enums::st::foreignfuture::foreignfuture::free
    jsi::Runtime &rt,
    std::shared_ptr<uniffi_runtime::UniffiCallInvoker> callInvoker,
    const jsi::Value &value) {
  if (rsLambda != nullptr) {
...
template <> struct Bridging<UniffiForeignFuture> {
  static UniffiForeignFuture fromJs(jsi::Runtime &rt,
    ...
    rsObject.free = uniffi::enums::st::foreignfuture::foreignfuture::free::
...
template <> struct Bridging<UniffiForeignFutureStructU8> {
  ...
  fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
    ...
    rsObject.call_status = uniffi::enums::Bridging<RustCallStatus>::fromJs(
...
template <> struct Bridging<UniffiForeignFutureCompleteU8> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::enums::Bridging<UniffiForeignFutureStructU8>::fromJs(
...
template <> struct Bridging<UniffiForeignFutureCompleteI8> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::enums::Bridging<UniffiForeignFutureStructI8>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteU16> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::enums::Bridging<UniffiForeignFutureStructU16>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteI16> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::enums::Bridging<UniffiForeignFutureStructI16>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteU32> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::enums::Bridging<UniffiForeignFutureStructU32>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteI32> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::enums::Bridging<UniffiForeignFutureStructI32>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteU64> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::enums::Bridging<UniffiForeignFutureStructU64>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteI64> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::enums::Bridging<UniffiForeignFutureStructI64>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteF32> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::enums::Bridging<UniffiForeignFutureStructF32>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteF64> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::enums::Bridging<UniffiForeignFutureStructF64>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompletePointer> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::enums::Bridging<UniffiForeignFutureStructPointer>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureStructRustBuffer> {
  ...
  fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
    ...
    // Create the vtable from the js callbacks.
    rsObject.return_value = uniffi::enums::Bridging<RustBuffer>::fromJs(
        rt, callInvoker, jsObject.getProperty(rt, "returnValue"));
    rsObject.call_status = uniffi::enums::Bridging<RustCallStatus>::fromJs(
        rt, callInvoker, jsObject.getProperty(rt, "callStatus"));
...
template <> struct Bridging<UniffiForeignFutureCompleteRustBuffer> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::enums::Bridging<UniffiForeignFutureStructRustBuffer>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteVoid> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::enums::Bridging<UniffiForeignFutureStructVoid>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiRustFutureContinuationCallback> {
  ...
  fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
         const jsi::Value &value) {
    try {
      return uniffi::enums::cb::rustfuturecontinuationcallback::
...
NativeEnums::NativeEnums(
  ...
  props["ubrn_ffi_enums_uniffi_contract_version"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(rt,
                                    "ubrn_ffi_enums_uniffi_contract_version"),
          0,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_ffi_enums_uniffi_contract_version(rt, thisVal,
                                                               args, count);
          });
}

void NativeEnums::registerModule(
    jsi::Runtime &rt, std::shared_ptr<react::CallInvoker> callInvoker) {
  auto invoker =
      std::make_shared<uniffi_runtime::UniffiCallInvoker>(callInvoker);
  auto tm = std::make_shared<NativeEnums>(rt, invoker);
  auto obj = rt.global().createFromHostObject(rt, tm);
  rt.global().setProperty(rt, "NativeEnums", obj);
}

void NativeEnums::unregisterModule(jsi::Runtime &rt) {
  uniffi::enums::registry::clearRegistry();
}

jsi::Value NativeEnums::get(jsi::Runtime &rt, const jsi::PropNameID &name) {
  try {
...
std::vector<jsi::PropNameID> NativeEnums::getPropertyNames(jsi::Runtime &rt) {
...
void NativeEnums::set(jsi::Runtime &rt, const jsi::PropNameID &name,
                      const jsi::Value &value) {
...
NativeEnums::~NativeEnums() {
  ...
  uniffi::enums::cb::rustfuturecontinuationcallback::cleanup();
  // Cleanup for "free" callback function CallbackInterfaceFree
  uniffi::enums::st::foreignfuture::foreignfuture::free::cleanup();
}

// Utility functions for serialization/deserialization of strings.
jsi::Value NativeEnums::cpp_uniffi_internal_fn_func_ffi__string_to_byte_length(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
  return uniffi_jsi::Bridging<std::string>::string_to_bytelength(rt, args[0]);
}

jsi::Value NativeEnums::cpp_uniffi_internal_fn_func_ffi__string_to_arraybuffer(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
  return uniffi_jsi::Bridging<std::string>::string_to_arraybuffer(rt, args[0]);
}

jsi::Value NativeEnums::cpp_uniffi_internal_fn_func_ffi__arraybuffer_to_string(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
...
jsi::Value NativeEnums::cpp_ffi_enums_uniffi_contract_version(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
  auto value = ffi_enums_uniffi_contract_version();
