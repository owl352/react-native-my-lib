...
class NativeEnums : public jsi::HostObject {
private:
...
protected:
  ...
  jsi::Value cpp_uniffi_internal_fn_func_ffi__arraybuffer_to_string(
      jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
      size_t count);
  jsi::Value cpp_ffi_enums_uniffi_contract_version(jsi::Runtime &rt,
                                                   const jsi::Value &thisVal,
                                                   const jsi::Value *args,
                                                   size_t count);

public:
  NativeEnums(jsi::Runtime &rt,
              std::shared_ptr<uniffi_runtime::UniffiCallInvoker> callInvoker);
  virtual ~NativeEnums();
   ...
   *
   * React Native must call `NativeEnums.registerModule(rt, callInvoker)` before
   ...
   * be the case.
   *
   * Clients should call `NativeEnums.unregisterModule(rt)` after final use
   * where possible.
   */
